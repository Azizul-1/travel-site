...
var RvealOnScroll = function () {
  function RvealOnScroll(els, offset) {
    _classCallCheck(this, RvealOnScroll);
  ...
  return RvealOnScroll;
}();

exports.default = RvealOnScroll;
